...
model = torch.hub.load(r'C:\Users\HHR6\PycharmProjects\ALPR\yolov5', 'custom', path=r'C:\Users\HHR6\PycharmProjects\AcksessionIntegration\LP_Recognition\Arabic_OCR\Models\Arabic_OCR_new.onnx',
                       source='local')
...
output_dir = r'./output_irqa_valid'
...
def inference_image_iraqi(input_path):
    with open(output_file_path, 'w') as f:
            # Resize the image
            resized_image = resize_image(input_path)
